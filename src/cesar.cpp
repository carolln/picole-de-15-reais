...
class ULA{
    ...
    void add(string reg_value, string reg_value2) {
        int a = std::stoi(reg_value);
        int b = std::stoi(reg_value2);
        //RA.receive(std::to_string(a+mem_val));
        result = a + b;

    }

    void sub(string reg_value, string reg_value2) {
        int a = std::stoi(reg_value);
        int b = std::stoi(reg_value2);
        result = a - b;
        //RA.receive(std::to_string(a-mem_val));
    ...
    void andy(string reg_value, string reg_value2) {
        int a = std::stoi(reg_value);
        //RA.receive(std::to_string(a&mem_val));
        int b = std::stoi(reg_value2);
        result = a & b; 
    ...
    void ore(string reg_value, string reg_value2) {
        int a = std::stoi(reg_value2);
        //RA.receive(std::to_string(a|mem_val));
        int b = std::stoi(reg_value2); 
        result = a | b;
    }
    ...
    void ror(string reg_value) {
        int a = std::stoi(reg_value);
        result = a/2;
    }

    void rol(string reg_value) {
        int a = std::stoi(reg_value);
        result = a*2;
    }

    void asr(string reg_value) {
        int a = std::stoi(reg_value);
        result = a/2;
    }

    void asl(string reg_value) {
        int a = std::stoi(reg_value);
        result = a*2;
    }
    ...
    void inc(string reg_value) {
        int a = std::stoi(reg_value);
        result = a+1;
    }

    void dec(string reg_value) {
        int a = std::stoi(reg_value);
        result = a-1;
    }

    void tst(string reg_value) {
        int a = std::stoi(reg_value);
        result = a;
    }

    void adc(string reg_value) {
        int a = std::stoi(reg_value);
        result = a+1;
    }

    void abc(string reg_value) {
        int a = std::stoi(reg_value);
        result = a-1;
    }
...
class Ramses{
    ...
    void print() {
        ...
        std::cout << "Flag de controle V: " << V << "\n";
        std::cout << "Registrador 0: " << parte_operativa.R[0].return_reg() << "\n";
        std::cout << "Registrador 1: " << parte_operativa.R[1].return_reg() << "\n";
        std::cout << "Registrador 2: " << parte_operativa.R[2].return_reg() << "\n";
        std::cout << "Registrador 3: " << parte_operativa.R[3].return_reg() << "\n";
        std::cout << "Registrador 4: " << parte_operativa.R[4].return_reg() << "\n";
        std::cout << "Registrador 5: " << parte_operativa.R[5].return_reg() << "\n";
        std::cout << "Registrador 6: " << parte_operativa.R[6].return_reg() << "\n";
        std::cout << "Registrador 7: " << parte_operativa.R[7].return_reg() << "\n";
        ...
        void ciclo_de_exe () { // LEMBRAR DE SAIR DO CICLO DE BUSCA EM ALGUM CICLO ESPECIFICO IDK
            ...
            case uni_cont.sinais_controle::cargaREM:
                ...
                if (parte_operativa.operation_code.return_operation()[2] == "3") {
                    parte_operativa.rem.str(std::stoi(parte_operativa.readmem.return_rdm()[0]) + std::stoi(parte_operativa.R[7].return_reg()));
                }
            ...
            case uni_cont.sinais_controle::mux_ula:
                ...
                if (parte_operativa.operation_code.return_operation()[1] == "0") {// RA
                    op1 = parte_operativa.R[0].return_reg();
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "1") {// RA
                    op1 = parte_operativa.R[1].return_reg();
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "2") {// RA
                    op1 = parte_operativa.R[2].return_reg();
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "3") {// RA
                    op1 = parte_operativa.R[3].return_reg();
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "4") {// RA
                    op1 = parte_operativa.R[4].return_reg();
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "5") {// RA
                    op1 = parte_operativa.R[5].return_reg();
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "6") {// RA
                    op1 = parte_operativa.R[6].return_reg();
                }
                else {// RA
                    op1 = parte_operativa.R[7].return_reg();
                }
            ...
            case uni_cont.sinais_controle::selUAL:
                ...
                if (parte_operativa.operation_code.return_operation()[1] == "0") {// RA
                    uni_cont.sc = uni_cont.sinais_controle::cargaR0;
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "1") {// RA
                    uni_cont.sc = uni_cont.sinais_controle::cargaR1;
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "2") {// RA
                    uni_cont.sc = uni_cont.sinais_controle::cargaR2;
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "3") {// RA
                    uni_cont.sc = uni_cont.sinais_controle::cargaR3;
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "4") {// RA
                    uni_cont.sc = uni_cont.sinais_controle::cargaR4;
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "5") {// RA
                    uni_cont.sc = uni_cont.sinais_controle::cargaR5;
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "6") {// RA
                    uni_cont.sc = uni_cont.sinais_controle::cargaR6;
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "7") {// RA
                    uni_cont.sc = uni_cont.sinais_controle::cargaR7;
                }
                ...
                if (parte_operativa.operation_code.return_operation()[0] == "1") { // str
                    ...
                    parte_operativa.unidade_arit.rol(op1);
                }
                ...
                //({"jz", "10"});
                //({"hlt", "15"});
            case uni_cont.sinais_controle::cargaR0:
                ...
                if (parte_operativa.operation_code.return_operation()[0] == "1") { // str
                    ...
                    parte_operativa.R[0].receive(std::to_string(parte_operativa.unidade_arit.result)); // isso eh para load, add, sub, and, or, not
                    uni_cont.sc = uni_cont.sinais_controle::incrementaPC;
                    is_ciclo_exe_over = 1;
            ...
            case uni_cont.sinais_controle::cargaR1:
                //parte_operativa.rem.str();
                ...
                if (parte_operativa.operation_code.return_operation()[0] == "1") { // str
                    ...
                    parte_operativa.R[1].receive(std::to_string(parte_operativa.unidade_arit.result)); // isso eh para load, add, sub, and, or, not
                    uni_cont.sc = uni_cont.sinais_controle::incrementaPC;
                    is_ciclo_exe_over = 1;
            ...
            case uni_cont.sinais_controle::cargaR2:
                //parte_operativa.rem.str();
                ...
                if (parte_operativa.operation_code.return_operation()[0] == "1") { // str
                    ...
                    parte_operativa.R[2].receive(std::to_string(parte_operativa.unidade_arit.result)); // isso eh para load, add, sub, and, or, not
                    uni_cont.sc = uni_cont.sinais_controle::incrementaPC;
                    is_ciclo_exe_over = 1;
            ...
            case uni_cont.sinais_controle::write:
                ...
                if (parte_operativa.operation_code.return_operation()[1] == "0") {// RA
                    parte_operativa.memoria.write(parte_operativa.R[0].return_reg(), std::stoi(parte_operativa.readmem.return_rdm()[0]));
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "1") {// RA
                    parte_operativa.memoria.write(parte_operativa.R[1].return_reg(), std::stoi(parte_operativa.readmem.return_rdm()[0]));
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "2") {// RA
                    parte_operativa.memoria.write(parte_operativa.R[2].return_reg(), std::stoi(parte_operativa.readmem.return_rdm()[0]));
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "3") {// RA
                    parte_operativa.memoria.write(parte_operativa.R[3].return_reg(), std::stoi(parte_operativa.readmem.return_rdm()[0]));
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "4") {// RA
                    parte_operativa.memoria.write(parte_operativa.R[4].return_reg(), std::stoi(parte_operativa.readmem.return_rdm()[0]));
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "5") {// RA
                    parte_operativa.memoria.write(parte_operativa.R[5].return_reg(), std::stoi(parte_operativa.readmem.return_rdm()[0]));
                }
                else if (parte_operativa.operation_code.return_operation()[1] == "6") {// RA
                    parte_operativa.memoria.write(parte_operativa.R[6].return_reg(), std::stoi(parte_operativa.readmem.return_rdm()[0]));
                }
                else {// RA
                   parte_operativa.memoria.write(parte_operativa.R[7].return_reg(), std::stoi(parte_operativa.readmem.return_rdm()[0]));
                }
